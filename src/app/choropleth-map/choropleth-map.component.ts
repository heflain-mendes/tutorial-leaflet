...
export class ChoroplethMapComponent implements AfterViewInit {
  ...
  zoomToFeature(e: L.LeafletMouseEvent) {
  ...
  ngAfterViewInit(): void {
    ...
    function style(
      feature: GeoJSON.Feature<GeoJSON.Geometry, { density: any }> | undefined
    ) {
    ...
    const onEachFeature = (
      ...
      layer.on({
        ...
        click: (e: L.LeafletMouseEvent) => {this.zoomToFeature(e)},
      });
    }
  ...
  statesData = {
    type: 'FeatureCollection' as GeoJSON.GeoJsonTypes,
    features: [
      {
        type: 'Feature',
        id: '01',
